#define _Py_FatalErrorFunc _PyPy_FatalErrorFunc
...
#define PyErr_FormatV PyPyErr_FormatV
...
#define PyEval_GetFuncDesc PyPyEval_GetFuncDesc
...
#define PyType_GetModuleByDef PyPyType_GetModuleByDef
#define PyOS_getsig PyPyOS_getsig
#define PyOS_setsig PyPyOS_setsig
#define PyType_GetName PyPyType_GetName
#define PyType_GetQualName PyPyType_GetQualName
...
#define PyThread_acquire_lock_timed PyPyThread_acquire_lock_timed
...
#define Py_Version PyPy_Version
#define _Py_PackageContext _PyPy_PackageContext
...
#define PyFloat_Pack2 PyPyFloat_Pack2
#define PyFloat_Pack4 PyPyFloat_Pack4
#define PyFloat_Pack8 PyPyFloat_Pack8
#define PyFloat_Unpack2 PyPyFloat_Unpack2
#define PyFloat_Unpack4 PyPyFloat_Unpack4
#define PyFloat_Unpack8 PyPyFloat_Unpack8
#define _PyFloat_InitState _PyPyFloat_InitState
